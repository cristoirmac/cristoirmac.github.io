...
export const experience: ExperienceChapter[] = [
  {
    ...
    changes: [
      ...
      'Owned security, privacy, compliance, and AI governance (SOC 2 Type II, PCI, GDPR/CCPA, NIST 800-171, vulnerability management, incident response), and improved R&D and infrastructure efficiency through platform consolidation, global-team leverage, and cloud-cost discipline.',
    ],
    outcomes: [

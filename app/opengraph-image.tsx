    ...
    (
      ...
      >
        <div style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
          ...
          <div style={{ fontSize: 26, color: '#3a5a5c', letterSpacing: 2, textTransform: 'uppercase' }}>
            Chief Technology Officer
          </div>
        </div>

        <div style={{ display: 'flex', flexDirection: 'column' }}>
          <div style={{ fontSize: 76, color: '#1a1a18', lineHeight: 1.05, fontWeight: 500, maxWidth: 980 }}>
